...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter(Context context, ArrayList<String> imagePaths, RecyclerView rvGrid, RecyclerViewAdapter.OnItemClickListener onItemClickListener) {
        mContext = context;
